...
# Copyright (C) 2021 SebaUbuntu's TWRP device tree generator / Chernobylll
# By Chernobylll
...
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 40640512 # This is the maximum known partition size, but it can be higher, so we just omit it
